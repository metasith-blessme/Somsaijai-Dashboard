...
## แก้ไข 2026-08-28 — ระบุตัวบุคคลผิด (สำคัญ)

**ฐิติภูมิ สิงห์ (SCB X0159 / พร้อมเพย์ X8850) เป็นฝั่ง Blessme ไม่ใช่ Ming** เจ้าของยืนยันเอง
และตรงกับหลักฐาน: 14/05/2026 โอน ฿50,345 เข้าฐิติภูมิ = ส่วนแบ่ง Blessme เดือน เม.ย. เป๊ะ
ตามที่ไฟล์นี้คำนวณไว้เอง

ดังนั้นบรรทัด `02/01/2026 | 47,961 | 32,000 | Dec25` ในตารางด้านบน **ระบุผิด** — ก้อน ฿32,000
ไม่ใช่ของ Ming

**Ming (เมน) = MR. AUNG MIN PHAY (X7485) เท่านั้น** เป็นทั้งหุ้นส่วนและลูกจ้าง
เป็นคนพม่า และมักได้รับส่วนแบ่งเป็น**เงินสด** จึงไม่มีร่องรอยในธนาคาร:

| เดือน | Ming ได้ | Blessme ได้ | รวม | สัดส่วน |
|---|---:|---:|---:|---|
| ม.ค. | 50,511.60 (เงินสด) | 75,767.40 | 126,279 | 60/40 |
| ก.พ. | 57,035.60 (เงินสด) | 85,553.40 | 142,589 | 60/40 |
| มี.ค. | 25,801.31 | 38,701.97 | 64,503 | 60/40 |

ยืนยันโดยเจ้าของ 2026-08-28 ทั้งสามเดือนออกมา 60/40 พอดี

## แก้ไข 2026-08-28 — ลบรายการซ้ำ ฿40,123

`audit/fix_duplicates.js` (ตรวจด้วย `audit/find_duplicates.js` ก่อน ทุกบรรทัดเทียบกับ statement แล้ว)

- 28/01 rows 48-50 — copy ซ้ำของ rows 45-47 (486 + 400 + 4,000)
- 28/02 ฿2,237 "ค่าส่งส้ม" ลงสองครั้ง ธนาคารจ่ายครั้งเดียว
- 31/07 ฿2,000 — audit เติมทับของเดิมโดยเขียนว่า "missing entry"
- 30/04 `Employee 1` ฿19,000 + `Employee 2` ฿12,000 = ก้อนเดียวกับ `[bank]` ฿31,000
- 01/04 ฿24,600 "เงินเดือน 3 คน มี.ค." ย้าย Apr26 -> Mar26

**ไม่ได้ลบ** 5 รายการที่ยอดซ้ำแต่ธนาคารจ่ายจริงสองครั้ง: 23/01 & 26/01 Lalamove ฿400,
05/03 ฿7,312 (คนละผู้รับ), 22/06 ฿700, 21/06 Shopee ฿1,210

ผลลัพธ์: เม.ย. เลิกขาดทุนปลอม (−54,275 -> +26,053) และ ม.ค. ออกมา ฿126,571
เทียบกับที่จ่ายจริง ฿126,279 ต่างกัน 292 บาท

ดู `.claude/skills/ledger-integrity/SKILL.md` สำหรับกฎการลงบัญชี
